...
-- Userbase
INSERT INTO users (first_name, last_name, phone_number, email, password, position_id, location_id, specialization_id, user_name)
VALUES ('Marthe', 'Nordnes', 42682942, 'marthe@nordnes.no', 'passord123', 2, 1, 1, 'marthenordnes'),
